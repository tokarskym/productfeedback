      ...
      comments: [
        {
          ...
          user: {
            image: '/images/user-images/image-suzanne.jpg',
            name: 'Suzanne Chang',
            username: 'upbeat1811',
          },
        },
        {
          ...
          user: {
            image: '/images/user-images/image-thomas.jpg',
            name: 'Thomas Hood',
      ...
      comments: [
        {
          ...
          user: {
            image: '/images/user-images/image-elijah.jpg',
            name: 'Elijah Moss',
        ...
        },
        {
          ...
          user: {
            image: '/images/user-images/image-james.jpg',
            name: 'James Skinner',
          ...
          replies: [
            {
              ...
              user: {
                image: '/images/user-images/image-anne.jpg',
                name: 'Anne Valentine',
                username: 'annev1990',
              },
            },
            {
              ...
              user: {
                image: '/images/user-images/image-ryan.jpg',
                name: 'Ryan Welles',
      ...
      comments: [
        {
          ...
          user: {
            image: '/images/user-images/image-george.jpg',
      ...
      comments: [
        {
          ...
          user: {
            image: '/images/user-images/image-javier.jpg',
            name: 'Javier Pollard',
        ...
        },
        {
          ...
          user: {
            image: '/images/user-images/image-roxanne.jpg',
            name: 'Roxanne Travis',
      ...
      comments: [
        {
          ...
          user: {
            image: '/images/user-images/image-victoria.jpg',
            name: 'Victoria Mejia',
        ...
        },
        {
          ...
          user: {
            image: '/images/user-images/image-jackson.jpg',
            name: 'Jackson Barker',
